...
RSpec.describe Merchant do
  ...
  describe 'Instance Methods' do
    before :each do
      ...
      @user_1 = User.create!(name: 'Megan', street: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, email: 'megan_1@example.com', password: 'securepassword')
      @user_2 = User.create!(name: 'Megan', street: '123 Main St', city: 'Denver', state: 'IA', zip: 80218, email: 'megan_2@example.com', password: 'securepassword')

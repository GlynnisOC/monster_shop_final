...
RSpec.describe 'Site Navigation' do
  ...
  describe 'As a Merchant User' do
    before :each do
      ...
      @m_user = @merchant.users.create(name: 'Megan', street: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, email: 'megan@example.com', password: 'securepassword')
  ...
  describe 'As an Admin' do
    before :each do
      @admin = User.create(name: 'Megan', street: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, email: 'megan@example.com', password: 'securepassword', role: :admin)

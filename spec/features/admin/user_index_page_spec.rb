...
RSpec.describe "Admin Users Index" do
  describe "As an Admin" do
    before :each do
      ...
      @m_address = @m_user.addresses.create!(street: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)
      ...
      @a_address = @a_user.addresses.create!(street: '123 Main St', city: 'Denver', state: 'CO', zip: 80218)

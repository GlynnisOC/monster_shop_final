...
RSpec.describe 'Admin Dashboard' do
  describe 'As an Admin' do
    before :each do
      ...
      @m_address = @m_user.addresses.create!(street: "Street", city: "City", state: "Washington", zip: 98765)
      ...
      @order_1 = @m_user.orders.create!(address_id: @m_address.id, status: "packaged")
      @order_2 = @m_user.orders.create!(address_id: @m_address.id, status: "pending")
      @order_3 = @m_user.orders.create!(address_id: @m_address.id, status: "cancelled")

...
RSpec.describe 'Merchant Item Index' do
  describe 'As a Merchant employee' do
    before :each do
      ...
      @m_address = @m_user.addresses.create!(street: "Street TWO", city: "Citytwo", state: "Missouri", zip: 43567)
      ...
      @order_3 = @m_user.orders.create!(address_id: @m_address.id, status: "pending")

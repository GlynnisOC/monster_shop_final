...
RSpec.describe 'Merchant Dashboard' do
  describe 'As an employee of a merchant' do
    before :each do
      ...
      @address = @m_user.addresses.create!(street: "Street", city: "City", state: "Washington", zip: 98765)
      ...
      @order_1 = @m_user.orders.create!(address_id: @address.id, status: "pending")
      @order_2 = @m_user.orders.create!(address_id: @address.id, status: "pending")
      @order_3 = @m_user.orders.create!(address_id: @address.id, status: "pending")
